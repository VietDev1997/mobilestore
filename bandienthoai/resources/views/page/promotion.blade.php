        ...
        <div class="container">
            ...
            <!-- Sidebar end=============================================== -->
                <div class="span9">
                    ...
                    <h4> Các sản phẩm đang khuyến mãi
                        <small class="pull-right"> Có {{ count($promotionProducts) }} sản phẩm khuyến mãi</small>
                    </h4>
                    <hr class="soft"/>
                    ...
                    <div class="pagination">{{ $promotionProducts->links() }}</div>
                    <br class="clr"/>
                </div>
            </div>
        </div>
